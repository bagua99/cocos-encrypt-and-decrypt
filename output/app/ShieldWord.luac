...
function gt.CheckShieldWord(_string)
	local count = table.getn(gt.ShieldWordTab)
	gt.log("shield word count = " .. count)
	for i = 1, count do
		if string.find(_string, gt.ShieldWordTab[i]) ~= nil then
			gt.log("gt.ShieldWordTab[i] = " .. gt.ShieldWordTab[i] .. ", i = " .. i)
			return true
		end
	end
	return false
